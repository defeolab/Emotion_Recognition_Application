...
def start():
    ...
    _, sample_freq = sf.read(r"C:\Users\Neuromarketing\PycharmProjects\Emotion_Recognition_Application\new1_signal1_record_112_1.wav")

    # read from the csv file to extract the time, left and right channel butterworth filter
    df = pd.read_csv(r'C:\Users\Neuromarketing\PycharmProjects\Emotion_Recognition_Application\new1_signal1_record_112_1.csv')
